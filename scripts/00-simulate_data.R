...
cat("Test 3 - Collisions columns have 'YES' or 'NO' values:", 
    test_collisions, "\n")
...
cat("Test 4 - Vehicle and person involvement columns have 'YES' or 'NO':", 
    test_vehicle_person, "\n")
...
cat("Test 5 - Hour column contains values between 0 and 23:", 
    test_hour_range, "\n")
